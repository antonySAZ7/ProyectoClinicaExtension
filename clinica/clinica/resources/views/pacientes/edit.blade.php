        ...
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div class="overflow-hidden rounded-xl border border-gray-200 bg-white shadow-sm">
                <div class="border-b border-gray-100 px-6 py-4">
                    <p class="text-sm text-gray-600">Actualiza el expediente y su posible vinculacion con el usuario paciente.</p>
                </div>

                <form method="POST" action="{{ route('pacientes.update', $paciente) }}" class="space-y-6 px-6 py-6">
                    @csrf
                    @method('PUT')
                    ...
                    <div>
                        ...
                        >
                            ...
                            @foreach ($usuariosPaciente as $usuarioPaciente)
                                <option value="{{ $usuarioPaciente->id }}" @selected(old('user_id', $paciente->user_id) == $usuarioPaciente->id)>
                    ...
                    <div class="grid gap-6 sm:grid-cols-2">
                        <div class="sm:col-span-2">
                            ...
                            <input id="nombre_completo" type="text" name="nombre_completo" value="{{ old('nombre_completo', $paciente->nombre_completo) }}" required class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-gray-400 focus:ring-gray-400">
                        </div>

                        <div>
                            <label for="dpi" class="block text-sm font-medium text-gray-700">DPI <span class="text-red-500" aria-hidden="true">*</span></label>
                            <input id="dpi" type="text" name="dpi" value="{{ old('dpi', $paciente->dpi) }}" required class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-gray-400 focus:ring-gray-400">
                        </div>
                        ...
                        <div>
                            ...
                            <input id="fecha_nacimiento" type="date" name="fecha_nacimiento" value="{{ old('fecha_nacimiento', $paciente->fecha_nacimiento) }}" required class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-gray-400 focus:ring-gray-400">
                        </div>
                        ...
                        <div>
                            ...
                            <input id="telefono" type="text" name="telefono" value="{{ old('telefono', $paciente->telefono) }}" required class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-gray-400 focus:ring-gray-400">
                        </div>
                        ...
                        <div>
                            ...
                            <input id="correo" type="email" name="correo" value="{{ old('correo', $paciente->correo) }}" required class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-gray-400 focus:ring-gray-400">
                        </div>
                        ...
                        <div class="sm:col-span-2">
                            ...
                            <input id="direccion" type="text" name="direccion" value="{{ old('direccion', $paciente->direccion) }}" required class="mt-1 block w-full rounded-md border-gray-300 text-sm shadow-sm focus:border-gray-400 focus:ring-gray-400">
                        </div>
                    </div>
