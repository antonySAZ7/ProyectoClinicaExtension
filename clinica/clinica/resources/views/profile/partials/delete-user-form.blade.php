<section class="space-y-6">
    <header>
        ...
        <p class="mt-1 text-sm text-gray-600">
            Una vez eliminada tu cuenta, todos sus datos y recursos se borraran de forma permanente. Antes de continuar, asegurate de conservar la informacion que necesites.
        </p>
    </header>
